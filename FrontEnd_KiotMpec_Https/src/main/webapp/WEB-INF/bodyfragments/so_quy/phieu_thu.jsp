...
<%--===========================modal===============================--%>
<div class="modal fade" id="modal-phieu-thu" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Lập phiếu thu(tiền mặt)</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <select id="select-loai-thu" class="selectize-control control-form single"
                                data-placeholder="Chọn loại thu . . . ">
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="caifop1li form-group col-md-4">
                    ...
                    <div class="col-md-6">
                        <select id="select-khach-hang" class="selectize-control control-form single"
                                data-placeholder="Tên người nộp . . . ">
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="caifop1li form-group">
                            <input type="text" class="form-control" id="gia-tri" min="0"
                                   placeholder="Giá trị">
    ...
    <div class="buifmaop">
        <div class="buifmaop">
            <div class="buifmaoptitle">
                <span class="page-title">Danh sách phiếu thu</span>
            </div>
            <div class="buifmaopct">
                <div class="row">
                    <div class="col-md-4">
                        <div class="caifop1li form-group">
                            <input type="text" class="form-control" id="bimo1" placeholder="Mã phiếu thu">
                            <span class="help-block">Help block with success</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="caifop1li form-group">
                            <input type="text" class="form-control" id="bimo2" placeholder="Tên loại thu">
                            <span class="help-block">Help block with success</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3 text-center">
                        <button class="btn btn-primary" id="btn-search"><i class="fas fa-fw fa-search"></i> Tìm Kiếm
                        </button>
                    </div>

                    <div class="col-xs-3 text-center">
                        <button class="btn btn-primary" id="btn-creat_new" data-toggle="modal"
                                data-target="#modal-phieu-thu"><i class="far fa-plus"></i> Tạo phiếu thu
                        </button>
                    </div>

                    <div class="col-xs-3 text-center">
                        <button class="btn btn-primary" id="btn-excel"><i class="fa fa-print"></i> In danh sách phiếu
                            thu
                        </button>
                    </div>
        ...
        <div class="buifmaoptb table-responsive">
            <table class="table table-hover table-condensed table-striped" id="table-phieu-thu">
                <tbody>
                <tr>
                    <th>STT</th>
                    <th>Mã phiếu thu</th>
...
<script src="resources/model/so_quy/ajax_phieu_thu.js"></script>
<script src="resources/pages/so_quy/ajax_phieu_thu.js"></script>
