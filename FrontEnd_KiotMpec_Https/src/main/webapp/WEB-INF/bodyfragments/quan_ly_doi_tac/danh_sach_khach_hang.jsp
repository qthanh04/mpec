    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="buifmaoptb table-responsive">
                <table class="table table-hover table-condensed table-striped" id="table-khach-hang">
                    <tbody>
                    <tr>
                        <th>STT</th>
            ...
            <div class="chuc-nang-nha-cung-cap">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <button class="btn btn-success" style="width: 100px" id="btn-them"><i class="far fa-plus"></i> Thêm</button>
                        <button class="btn btn-primary" style="width: 100px" id="btn-sua"><i class="fa fa-check-square"></i> Sửa</button>
                        <button class="btn btn-danger text-left" style="width: 100px" id="btn-xoa"><i class="far fa-trash-alt"></i> Xóa</button>
