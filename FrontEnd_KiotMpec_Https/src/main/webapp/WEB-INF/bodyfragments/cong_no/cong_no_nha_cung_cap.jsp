...
<section class="content" id="pageBody">
    <div class="buifmaop">
        <div class="buifmaoptitle">
            <span class="page-title">Công Nợ Nhà Cung Cấp</span>
        </div>
...
<script src="resources/model/cong_no/ajax_cong_no_nha_cung_cap.js"></script>
<script src="resources/pages/cong_no/ajax_cong_no_nha_cung_cap.js"></script>
