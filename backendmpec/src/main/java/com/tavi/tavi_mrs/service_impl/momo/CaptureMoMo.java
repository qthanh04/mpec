...
import com.tavi.tavi_mrs.entities.momo.CaptureMoMoRequest;
import com.tavi.tavi_mrs.entities.momo.CaptureMoMoResponse;
import com.tavi.tavi_mrs.entities.momo.PaymentResponse;
...
//            errorMoMoProcess(captureMoMoResponse.getErrorCode());
    ...
    public CaptureMoMoRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
        ...
        try {
            ...
            CaptureMoMoRequest captureMoMoRequest =new CaptureMoMoRequest(partnerInfo.getPartnerCode(),orderId, orderInfo,partnerInfo.getAccessKey(),amount,signRequest,extraData,requestId,notifyUrl,returnUrl,RequestType.CAPTURE_MOMO_WALLET);
